...
- Compare mode options:
  ...
  - `--direct-chunk-seconds 0`: auto safe direct chunking for long audio (30s chunks); set a value greater than the audio duration only to force a single full-file WhisperX pass.
