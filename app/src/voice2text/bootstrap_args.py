...
def build_arg_parser(whisper_defaults: WhisperRuntimeParams) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--speaker-profile-max-exemplars", type=int, default=None, help="Round 0061: bounded multi-exemplar profile representation. 1/unset = single-centroid (byte-identical). >1 lets a profile keep several distinct representative embeddings.")
