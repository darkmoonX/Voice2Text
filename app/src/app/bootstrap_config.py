...
def build_runtime_config(args: argparse.Namespace) -> RuntimeConfig:
    ...
    cfg = RuntimeConfig(
        ...
        vad_enabled=bool(args.vad_enabled),
        vad_backend=str(args.vad_backend),
        vad_rms_threshold=max(0.0, float(args.vad_rms_threshold)),
        vad_adaptive_enabled=bool(args.vad_adaptive_enabled),
        vad_adaptive_min_threshold=max(0.0, float(args.vad_adaptive_min_threshold)),
        vad_adaptive_max_threshold=max(0.0, float(args.vad_adaptive_max_threshold)),
        vad_adaptive_noise_multiplier=max(1.0, float(args.vad_adaptive_noise_multiplier)),
        vad_adaptive_margin=max(0.0, float(args.vad_adaptive_margin)),
